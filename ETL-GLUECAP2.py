...
S3_STAGING_DIR = "s3://psp-dvdrentalprojectcap2/output"
S3_BUCKET_NAME = "psp-dvdrentalprojectcap2"
...
dim_staff = staff[['staff_id', 'first_name', 'last_name', 'email', 'store_id', 'active', 'picture']]
...
dimStaff = dimStaff[['staff_id', 'picture', 'first_name', 'last_name', 'email', 'active',
...
factSales = factSales[['sales_id', 'staff_id', 'customer_id', 'film_id', 'date_id', 'sales_amount']]
...
conn = redshift_connector.connect(
    ...
    host='redshift-dvdrental.cmalnsdz0dqg.us-west-2.redshift.amazonaws.com',
    database='dvdrental',
    user=redshift_user,
...
for tablename in table_names:
    cursor.execute(f"""
    copy {tablename} from 's3://psp-dvdrentalprojectcap2/transformed_tables/{tablename}.csv'
    delimiter ','
    credentials 'aws_iam_role=arn:aws:iam::235494794192:role/service-role/AmazonRedshift-CommandsAccessRole-20241003T211037'
    region 'us-west-2'
    IGNOREHEADER 1
    """)
