...
st.set_page_config(page_title="SARIMA Forecasting", layout="wide")

st.title("SARIMA Forecasting")
st.write("This page performs SARIMA forecasting with parameter optimization.")
...
if 'log_sales_amount_diff' in weekly_sales.columns:
    st.write("Performing SARIMA Forecasting...")
    try:
        ...
        st.write(f"Best SARIMA Parameters: {best_params}")
        st.write(f"Best Seasonal Parameters: {best_seasonal_params}")
